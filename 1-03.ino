...
void loop()
{
	digitalWrite(8, LOW);	      // Turn the D6 LED off (LOW)
	...
	digitalWrite(6, LOW);	      // Turn the D7 LED off (LOW)
	digitalWrite(8, HIGH);	      // Turn the D8 LED on (HIGH)
	delay(500);				// Wait half a second (500 ms)
	
	digitalWrite(7, LOW);	      // Turn the D6 LED off (LOW)
	digitalWrite(4, HIGH);	      // Turn the D6 LED off (LOW)
	delay(500);				// Wait half a second (500 ms)
